...
public class Widget4x1 extends AppWidgetBase {
    ...
    public static final String COMMAND_WIDGET_UPDATE = "update_4x1";
        ...
        if (initialized) {
            ...
            if (isPlaying) {
                ...
                if (PlayerApplication.hasICS_MR1()) {
                    appWidgetView.setContentDescription(R.id.four_by_one_control_play, service.getString(R.string.cd_play));
                }
            } else {
