...
public class AppWidget4x2 extends AbstractAppWidget {
    ...
    public void doUpdate(Context context) {
        ...
        if (hasPlaylist) {
            ...
            if (isPlaying) {
                view.setImageViewResource(R.id.four_by_two_control_play, R.drawable.ic_action_playback_pause_dark);
                ...
                view.setImageViewResource(R.id.four_by_two_control_play, R.drawable.ic_action_playback_play_dark);
                if (PlayerApplication.hasICS_MR1()) {
                    view.setContentDescription(R.id.four_by_two_control_play, context.getString(R.string.imageview_content_description_play));
                }
            }
