...
import net.opusapp.player.utils.backport.android.utils.SharedPreferencesJsonStringSetWrapperUtils;
...
class PreferenceImplGB extends PreferenceImpl {
    ...
    public Set<String> getPersistedStringSet(
        ...
        return SharedPreferencesJsonStringSetWrapperUtils.getStringSet(pref.getSharedPreferences(), pref.getKey(), defaultReturnValue);
    }
    ...
    public boolean persistStringSet(Preference pref, Set<String> values) {
        if (shouldPersist(pref)) {
            ...
            return SharedPreferencesJsonStringSetWrapperUtils.putStringSet(pref.getEditor(), pref.getKey(), values);
        }
        return false;
    }
}