...
public class ServerManagedPolicy implements Policy {
	...
	public ServerManagedPolicy(Context context, Obfuscator obfuscator) {
		...
		mLastCheckTime = Long.parseLong(mPreferences.getString(PREF_LAST_CHECK, Long.toString(System.currentTimeMillis())));
	}
	...
	/**
	 * Set the timestamp of the check which was invoked by app. It should prevent cheats with changing the clock
	 * You must manually call PreferenceObfuscator.commit() to
	 * commit these changes to disk.
	 *
	 * @param lastCheckTime the System.currentTimeMillis()
	 */ 
	private void setLastCheckTime(Long lastCheckTime){
		mLastCheckTime = lastCheckTime > 0 ? lastCheckTime : System.currentTimeMillis();
		mPreferences.putString(PREF_LAST_CHECK, Long.toString(lastCheckTime));
	}
